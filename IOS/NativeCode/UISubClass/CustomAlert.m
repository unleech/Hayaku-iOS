...
//  CustomAlertView
//
//  Created by John Harry Cabamalan on 12/13/12.
//  Copyright (c) 2012 John Harry Cabamalan. All rights reserved.
//
...
- (id)initWithFrame:(CGRect)frame
{
    if((self = [super initWithFrame:frame]))
    {
        if(fillColor == nil)
        {
            fillColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1.0];
            borderColor = [UIColor colorWithHue:0.625
                                     saturation:0.0 brightness:0.8 alpha:1.0];
        }
    }
